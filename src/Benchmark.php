...
if (!interface_exists('nguyenanhung\MyDebug\Interfaces\BenchmarkInterface')) {
    include_once __DIR__ . DIRECTORY_SEPARATOR . 'Interfaces' . DIRECTORY_SEPARATOR . 'BenchmarkInterface.php';
}
